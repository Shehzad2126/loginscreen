  ...
  return (
    <ContentContainer>
      ...
      >
        ...
        <Card>
          ...
          <IconWrapper>
            ...
            <IconTextColored>
              <span style={{ color: "#C72C88" }}>70%</span>
              <img src={icon3} alt="" />
            </IconTextColored>
          </IconWrapper>
        </Card>
        <Card>
          <IconWrapper>
            <img
              ...
              className="icon1bg rounded-circle p-3"
            />
        ...
        <Card>
          <IconWrapper>
            <img
              src={icon1}
              alt="Total Clients Icon"
              className="icon2bg rounded-circle p-3"
            />
      ...
      >
        <div style={{ display: "flex" }}>
          ...
          {labelFilter.map((filter, index) => (
            <FilterInputContainer key={index}>
              ...
              <CrossIcon
                icon={faTimes}
                onClick={() => removeLabelFilter(filter, "label")}
              />
            </FilterInputContainer>
          ))}
        </div>
        <div>
          <Button>
            <img src={icon4} alt="upload" style={{ marginRight: 12 + "px" }} />
            Upload CVS
          </Button>
          <NewClient
            primary
          ...
          >
            <FontAwesomeIcon icon={faPlus} style={{ marginRight: 10 + "px" }} />
            New Client
          </NewClient>
        </div>
      </div>
