...
const Title = styled.h2`
  font-size: 24px;
  color: #333;
  margin-bottom: 0px; /* Added space below title */
  @media (max-width: 600px) {
    font-size: 20px;
  }
`;
...
const Subtitle = styled.p`
  font-size: 14px;
  color: #666;
  margin-bottom: 5px; /* Added space below subtitle */
  @media (max-width: 600px) {
    font-size: 12px;
  }
`;
...
const EmailText = styled.p`
  font-size: 16px;
  color: #333;
  margin-bottom: 5px; /* Added space below email */
  @media (max-width: 600px) {
    font-size: 14px;
  }
`;
  ...
  return (
    <SignupContainer>
      <ContentContainer>
        <FormOuterContainer>
          ...
          <FormSection>
            <FormContent>
              ...
              <EmailText>We sent the link to</EmailText>
              <Subtitle>
                <strong>{email}</strong>
              </Subtitle>
              <Subtitle>
        ...
        <ProgressBar>
          {[1, 2, 3, 4].map((step) => (
            <Step key={step} isCurrentStep={step === 2} />
          ))}
        </ProgressBar>
