...
//   width: 100%;
//   padding: 12px;
//   background-color: #008080 !important; // Ensure the button has a consistent background color
...
//   &:hover {
//     background-color: #006666 !important; // Darken the background on hover
//   }
...
//     // General error if all fields are empty
//     if (allFieldsEmpty) {
...
//     // Check if both password fields are empty and set a general error
...
//     // Set the errors and return validation status
//     if (Object.keys(newErrors).length > 0) {
//       setErrors(newErrors);
//       return false;
//     }
...
//     // Clear the password field error when user starts typing
//     if (errors.password) {
//       setErrors((prevErrors) => ({ ...prevErrors, password: "" }));
//     }

//     // Check password strength and set indication (not an error)
...
//     // Clear the confirm password field error when user starts typing
...
//       // New validation to check if passwords match
//       if (password !== confirmPassword) {
//         setErrors({ ...errors, confirmPassword: "Passwords do not match" });
//         return;
//       } else {
//         // Clear the confirmPassword error if passwords match
